        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="padding-bottom: 45px; padding-top: 65px;">
                    <div class="form-group">
                        <label for="medicos" class="col-md-2 col-xs-2 col-md-offset-1 control-label lbl">Seleccionar Doctor</label>
                        ...
                        <label for="medicos" class="col-md-2 col-xs-2 control-label lbl">Seleccionar Paciente</label>
                        <div class="col-md-3 col-xs-4">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="padding-bottom: 45px; padding-top: 65px;">
                  <div class="row">
                    <div class="form-group">
                      <label for="buscar" class="col-md-1 col-xs-1 col-md-offset-1 col-xs-offset-1 control-label lbl">Buscar</label>
                      <div class="col-md-9 col-xs-9">
                          <input id="myInput" type="text" class="form-control" onkeyup="buscarPresp()" placeholder=" Buscar por Pacientes">
                      </div>
                    </div>

                    <div class="row">
                      <div class="col-md-10 col-xs-12 col-md-offset-1" style="margin-top: 45px; margin-bottom: 45px;">
                                    ...
                                    <tbody>
                                        @foreach( $presupuestos as $row )
                                          <tr>
                                            ...
                                            <td class="text-center"><a href="presupuestos/create/{{$row->idMedico}}/{{$row->idPaciente}}/{{$row->id }}" class="btn btn-xs btn-success">Detalle</button></td>
                                            <td class="text-center">
                                              <form action="{{ route('presupuestos.destroy', $row->id) }}" method="post">
                                                  <input type="hidden" name="_method" value="DELETE">
                                                  <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                  <button id="{{ $row->id }}" name="eliminarpresp" type="submit" class="btn btn-xs btn-danger">Eliminar</button>
                                              </form>
                                            </td>
                                          </tr>
                                        @endforeach
