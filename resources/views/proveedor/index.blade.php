                        ...
                        <form class="form-horizontal" action="/core_v2/proveedors" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-xs-5">
                                    <input id="direccion" type="text" class="form-control" name="direccion"
                                           value="{{ old('direccion')}}" placeholder="Dirección" autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2 col-xs-2">
                                    <select name="insumo_id" id="insumo_id" class="form-control">
                                        ...
                                        @foreach( $insumos as $ins )
                                            <option value="{{ $ind++ }}"
                                                    @if(old('insumo_id') == '{{ $ins }}')selected @endif>{{ $ins }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-2 col-xs-2">
                                    <select name="tipo_id" id="tipo_id" class="form-control">
                                        ...
                                        @foreach( $tipo as $tip )
                                            <option value="{{ $ind++ }}"
                                                    @if(old('tipo_id') == '{{ $tip }}')selected @endif>{{ $tip }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-xs-4">
                                    <input id="banco" type="text" class="form-control" placeholder="Banco" name="banco"
                                           value="{{ old('banco')}}" autofocus>
                                ...
                                <div class="col-md-5 col-xs-5">
                                    <input id="nrocuenta" type="text" class="form-control"
                                           placeholder="Número de Cuenta" name="nrocuenta" value="{{ old('nrocuenta')}}"
                                           autofocus>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body" style="padding-bottom: 60px;">
                            ...
                            <input type="text" class="form-control" id="myInput" onkeyup="buscarProveedor()"
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <button class="btn btn-xs btn-info"
                                                            onclick="mostrarInfo('{{ $row->id }}', '{{ $row->nombres }}')"
                                                            data-toggle="modal" data-target="#modal-info">Info
                                                    </button>
                                                </td>
                                                <td class="text-center">
                                                    <button class="btn btn-xs btn-success"
                                                            onclick="mostrarDetalle('{{ json_encode($proveedor[$i]) }}')"
                                                            data-toggle="modal" data-target="#myModal">Detalle
                                                    </button>
                                                </td>
                                                <td class="text-center"><a
                                                            href="{{ route('proveedors.edit', $row->id) }}"
                                                            class="btn btn-xs btn-warning">Editar</a></td>
                                                @if(Auth::user()->rolid == 1)
                                                    <td class="text-center">
                                                        <form action="{{ route('proveedors.destroy', $row->id) }}"
                                                              method="post">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="padding-top: 60px;">
                        ...
                        <form id="form-detalle-proveedor" class="form-horizontal" method="post">
                            ...
                            <div class="form-group">
                                <label for="title-info"
                                       class="col-md-1 col-xs-2 col-md-offset-2 control-label">Nombre</label>
                                <div class="col-md-7 col-xs-10">
                                    <input id="title-info" type="text" class="form-control" name="nombre"
                                           placeholder="Nombre" required autofocus disabled>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7 col-xs-10">
                                    <input id="detalles" type="text" class="form-control" name="detalles"
                                           value="{{ old('detalles')}}" placeholder="Detalles" required autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7 col-xs-10">
                                    <input id="monto" type="text" class="form-control" name="monto"
                                           value="{{ old('monto')}}" placeholder="Monto">
                        ...
                        <!--  Table -->
                        <table id="tablaDetalleProveedor" class="table table-responsive table-hover"
