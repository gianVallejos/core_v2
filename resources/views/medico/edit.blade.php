            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" >
                    ...
                    <form class="form-horizontal" action="/core_v2/medicos/{{ $medico->id }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5 col-xs-5">
                                <input id="nombres" type="text" class="form-control" name="nombres" value="{{ $medico->nombres }}" placeholder="Nombres" required autofocus>
                            ...
                            <div class="col-md-5 col-xs-5">
                                <input id="apellidos" type="text" class="form-control" name="apellidos" value="{{ $medico->apellidos }}" placeholder="Apellidos" required autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2 col-xs-2">
                                <input id="dni" type="text" class="form-control" name="dni" value="{{ $medico->dni }}" placeholder="DNI" minlength="8" maxlength="8" required autofocus>
                            ...
                            <div class="col-md-4 col-xs-3">
                                <input id="email" type="text" class="form-control" name="email" value="{{ $medico->email }}" placeholder="E-mail">
                            ...
                            <div class="col-md-3 col-xs-3">
                                <input id="direccion" type="text" class="form-control" name="direccion" value="{{ $medico->direccion }}" placeholder="Dirección" required autofocus>
                    ...
                    <?php           }                                                 ?>
                              ...
                              <label for="margen_ganancia" class="col-md-2 col-xs-2 control-label">Margen de Ganancia</label>
                              <div class="col-md-2 col-xs-2">
                                  <input id="margen_ganancia" type="number" min="0" max="100" class="form-control" name="margen_ganancia" value="{{ $medico->margen_ganancia }}" placeholder="Margen (%)"  >
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-2 col-xs-2">
                              <input id="fechanacimiento" type="date" class="form-control" name="fechanacimiento" value="{{ $medico->fechanacimiento }}" required autofocus>
                            ...
                            <div class="col-md-2 col-xs-2">
                                <input id="telefono" type="text" class="form-control" name="telefono" value="{{ $medico->telefono }}" placeholder="Teléfono" >
                            ...
                            <div class="col-md-2 col-xs-2">
                                <input id="celular" type="text" class="form-control" name="celular" value="{{ $medico->celular }}" placeholder="Número de Celular"  >
                            ...
                            <div class="col-md-2 col-xs-2">
                                <input id="celular_aux" type="text" class="form-control" name="celular_aux" value="{{ $medico->celular_aux }}" placeholder="Número de Celular"  >
