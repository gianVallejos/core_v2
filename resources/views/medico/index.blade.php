            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" >
                    ...
                    <form class="form-horizontal" action="/core_v2/medicos" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2 col-xs-2">
                                <input id="dni" type="text" class="form-control" name="dni" value="{{ old('dni')}}" placeholder="DNI" minlength="8" maxlength="8" required autofocus>
                            ...
                            <div class="col-md-3 col-xs-3">
                                <input id="direccion" type="text" class="form-control" name="direccion" value="{{ old('direccion')}}" placeholder="Dirección" required autofocus>
                    ...
                    <?php           foreach($genero as $gr){                          ?>
                                        <option value="{{ $gr }}"  @if(old('genero') == '{{ $gr }}')selected @endif>{{ $gr }}</option>
                    <?php           }                                                 ?>
                                </select>
                    ...
                    <?php           foreach($estado as $stdo){                          ?>
                                        <option value="{{ $stdo }}"  @if(old('estado') == '{{ $stdo }}')selected @endif>{{ $stdo }}</option>
                    <?php           }                                                 ?>
                                </select>
                              ...
                              <div class="col-md-2 col-xs-2">
                                  <input id="margen_ganancia" type="number" min="0" max="100" class="form-control" name="margen_ganancia" value="{{ old('margen_ganancia')}}" placeholder="Margen (%)"  >
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-2 col-xs-2">
                            ...
                            <div class="col-md-2 col-xs-2">
                                <input id="celular" type="text" class="form-control" name="celular" value="{{ old('celular')}}" placeholder="Número de Celular"  >
                            ...
                            <div class="col-md-2 col-xs-2">
                                <input id="celular_aux" type="text" class="form-control" name="celular_aux" value="{{ old('celular_aux')}}" placeholder="Número de Celular"  >
                            ...
                            <tbody>
                                ...
                                @foreach( $data as $row )
                                  <tr>
                                    ...
                                    <td class="text-center"><button class="btn btn-xs btn-success" onclick="mostrarDetalle('{{ json_encode($data[$i]) }}')" data-toggle="modal" data-target="#myModal">Detalle</button></td>
                                    <td class="text-center"><a href="{{ route('medicos.edit', $row->id) }}" class="btn btn-xs btn-warning">Editar</a></td>
                                    <td class="text-center">
                                      <form action="{{ route('medicos.destroy', $row->id) }}" method="post">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <label for="fechanacimiento" class="col-md-2 col-md-offset-1 control-label">Nacimiento:</label>
