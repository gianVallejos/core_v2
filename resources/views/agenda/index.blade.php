                  ...
                  <form id="cita-form" class="form-horizontal" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3 col-xs-12">
                            <input type="text" class="form-control" id="celular" name="celular" placeholder="Celular" disabled>
                        </div>
                        <div class="col-md-1 col-xs-6 text-right">
                          <button class="btn btn-success nuevoPaciente" data-toggle="modal" data-target="#nuevoPaciente" type="button">Nuevo</button>
                        </div>
                        <div class="col-md-1 col-xs-6 text-left">
                          <button class="btn btn-warning buscarPaciente" data-toggle="modal" data-target="#buscarPaciente" type="button">Buscar</button>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="tratamiento" class="col-md-1 col-md-offset-1 control-label">Tratamiento</label>
                        <div class="col-md-4">
                            <input class="form-control" type="text" name="tratamiento" id="tratamiento" placeholder="Escribir Tratamiento">
                        </div>
        ...
        <div class="col-md-12">
          <div class="panel panel-default">
              ...
              <div class="panel-body" >
                ...
                <div class="form-group">
                  <label for="doctor" class="col-md-1 col-md-offset-2 control-label" style="padding-top: 5px;">Doctor</label>
                  <div class="col-md-7">
        ...
        <div class="modal-body text-center" style="margin-top: 45px;">
          ...
          <form id="nuevoPacienteForm" class="form-horizontal" method="post">
              <div class="form-group">
                  ...
                  <div class="col-md-7">
                      <input type="text" class="form-control" name="nombrePaciente" id="nombrePaciente" placeholder="Nombre de Paciente">
                  </div>
              </div>
              <div class="form-group">
                  <label for="" class="col-md-2 col-md-offset-1 control-label">Celular:</label>
                  <div class="col-md-7">
                      <input type="text" class="form-control" name="celularPaciente" id="celularPaciente" placeholder="Celular de Paciente">
                  </div>
              </div>
              <div class="form-group">
                  <div class="col-md-12 text-center">
    ...
    <div class="modal-content">
      ...
      <div class="row" style="margin-top: 15px;">
        <div class="col-md-10 col-md-offset-1"> <!-- Buscar Paciente -->
            <input type="text" class="form-control" id="buscar-paciente" onkeyup="buscarPaciente()" placeholder=" Buscar por Nombres">
        </div>
      </div>
                    ...
                    <tbody>
                        ...
                        @foreach( $data as $row )
                          <tr>
                            ...
                            <td class="text-center"><button class="btn btn-xs btn-info" onclick="agregarACitaPaciente('{{ $row->nombres }} {{ $row->apellidos }}', '{{ $row->celular }}')">Aceptar</button></td>
                          </tr>
                          <?php $i++; ?>
                        @endforeach
                    </tbody>
