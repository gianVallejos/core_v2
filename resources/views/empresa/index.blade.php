        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="alert alert-warning text-center">
                    Al crear un empresa se clonarán todos los tratamientos registrados por defecto. <a
                            href="/core_v2/tratamientos">Ver tratamientos</a>
                </div>
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" action="/core_v2/empresas" method="POST">
                            ...
                            <div class="form-group">
                                <label for="nombre"
                                       class="col-md-1 col-xs-2 col-md-offset-1 control-label">Nombre</label>
                                ...
                                <div class="col-md-4 col-xs-9">
                                    <input id="ruc" type="text" minlength="11" maxlength="11" class="form-control"
                                           name="ruc" value="{{ old('ruc')}}" placeholder="RUC" required autofocus>
                                                ...
                                                <tr>
                                                    ...
                                                    @if(Auth::user()->rolid == 1)
                                                        <td class="text-center">
                                                            @if( $i > 2 )
                                                                <form action="{{ route('empresas.destroy', $row->id) }}"
                                                                      method="post">
