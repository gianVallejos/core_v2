    ...
    <div class="row">
        <div class="col-md-12">
          ...
          <div class="alert alert-warning text-center">
              Al crear un tratamiento se clonarán en todas las empresas registradas. <a href="/core_v2/empresas">Ver Empresas</a>
          </div>
                    ...
                    <form class="form-horizontal" action="/core_v2/tratamientos" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-xs-9">
                                <input id="detalle" type="text" class="form-control" name="detalle" value="{{ old('detalle')}}" placeholder="Nombre del Tratamiento" required autofocus>
                            ...
                            <div class="col-md-2 col-xs-4">
                                <input id="monto" type="text" class="form-control" name="monto" value="{{ old('monto')}}" placeholder="Monto Default" required autofocus>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <input id="myInput" type="text" class="form-control" onkeyup="buscarTratamiento()" placeholder=" Buscar por Detalles">
                    </div>
                  </div>
                        ...
                        <div id="table-scroll" style="height: 30vh;">
                          <table id="tablaTratamiento" class="table table-responsive table-hover">
                              ...
                              <tbody>
                                  ...
                                  @foreach( $data as $row )
                                    <tr>
                                      <td class="text-center">{{ $row->id }}</th>
                                      <td class="text-center col-md-8">{{ $row->detalle }}</td>
                                      <td class="text-center"><a href="{{ route('tratamientos.edit', $row->id) }}" class="btn btn-xs btn-warning">Editar</a></td>
                                      <td class="text-center">
                                        @if( $i > 7 )
                                        <form action="{{ route('tratamientos.destroy', $row->id) }}" method="post">
