                            ...
                            <div class="col-md-2 col-xs-2">
                                <select name="empresa_id" id="empresa_id" class="form-control">
                                    @foreach( $empresas as $stdo )
                                        <option value="{{ $stdo->id }}"  @if(old('empresa_id') == '{{ $stdo->nombre }}')selected @endif>{{ $stdo->nombre }}</option>
                                    @endforeach
                                </select>
                              ...
                              ?>
                                          <select name="seguro_ind" id="seguro_ind" class="form-control">
                                              @foreach($seguro as $stdo)
                                                  <option value="{{ $ind++ }}"  @if(old('seguro_ind') == '{{ $stdo }}')selected @endif>{{ $stdo }}</option>
                                              @endforeach
                                          </select>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="padding-bottom: 60px;">
                  ...
                  <input type="text" class="form-control" id="myInput2" onkeyup="buscarClte()" placeholder=" Buscar por Nombres y Apellidos"><br>
                            ...
                            <tbody>
                                ...
                                @foreach( $data as $row )
                                  <tr>
                                    ...
                                    <td class="text-center"><button class="btn btn-xs btn-success" onclick="mostrarDetallePaciente('{{ json_encode($data[$i]) }}')" data-toggle="modal" data-target="#myModal">Detalle</button></td>
                                    <td class="text-center"><a href="{{ route('pacientes.edit', $row->id) }}" class="btn btn-xs btn-warning">Editar</a></td>
                                    <td class="text-center">
                                      <form action="{{ route('pacientes.destroy', $row->id) }}" method="post">
